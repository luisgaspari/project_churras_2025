      ...
      >
        ...
        <View style={styles.header}>
          ...
          <View style={styles.headerInfo}>
            {conversation?.client_profile?.avatar_url ? (
              <Avatar.Image
                size={40}
                source={{ uri: conversation.client_profile.avatar_url }}
              />
            ) : (
              <Avatar.Text
                size={40}
                label={conversation?.client_profile?.full_name?.charAt(0).toUpperCase() || 'C'}
              />
            )}
            <View style={styles.headerText}>
              <Text variant="titleMedium" style={styles.headerTitle}>
                {conversation?.client_profile?.full_name}
              </Text>
